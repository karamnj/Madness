...
public class SponsorsWebViewActivity extends Activity {

    private static final String LOG_PREFIX = "SponsorsWebViewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsors_web_view);

        Log.d(LOG_PREFIX, "Finding WebView by ID");

        mWebView = (WebView) findViewById(R.id.sponsors_web_view);
