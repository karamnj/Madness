...
public class LocalSession implements Parcelable {
    ...
    private String isGeneralSession;
    private String slot;
    ...
    public LocalSession(Parcel in) {
        ...
        isGeneralSession = in.readString();
        slot = in.readString();
    }
    ...
    public String getIsGeneralSession() { return isGeneralSession; }
    ...
    public void setIsGeneralSession(String isGeneralSession) { this.isGeneralSession = isGeneralSession; }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeString(isGeneralSession);
    ...
    public boolean equals(Object o) {
        ...
        if (isGeneralSession != null ? !isGeneralSession.equals(that.isGeneralSession) : that.isGeneralSession != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (isGeneralSession != null ? isGeneralSession.hashCode() : 0);
