...
public class IgniteDatabase extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "madness.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.SPONSORS + " ("
                ...
                + SponsorColumns.SPONSOR_CATEGORY + " INTEGER NOT NULL,"
        ...
        db.execSQL("CREATE TABLE " + Tables.SESSIONS + " ("
                ...
                + SessionColumns.SESSION_IS_GENERAL_SESSION + " TEXT,"
                + SessionColumns.SESSION_SLOT + " TEXT,"
