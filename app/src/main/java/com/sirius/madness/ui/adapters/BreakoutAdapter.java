 ...
 */
public class BreakoutAdapter extends ArrayAdapter<SessionBean> {
    ...
    private static final String CLASS_NAME = "BreakoutAdapter";
    ...
    public BreakoutAdapter(Context context, int resource, SessionBean[] sessions) {
    ...
    public View getView(int position, final View convertView, final ViewGroup parent) {
        ...
        //if (!sessions[arrayIndex].getIsHidden().equalsIgnoreCase("true")) {
            ...
            // Set up view for Session Cell
                ...
                if(session.isHeader()){
                    Log.d("Breakout", "Header "+position);
