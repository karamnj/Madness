...
public abstract class BaseActivity extends ActionBarActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected static final int MENU_BAR_ITEM_MY_SCHEDULE = 9;
    protected static final int MENU_BAR_ITEM_SPEAKERS = 1;
    protected static final int MENU_BAR_ITEM_PARTNERS = 2;
    protected static final int MENU_BAR_ITEM_SPONSORS = 10;
    protected static final int MENU_BAR_ITEM_MAPS = 3;
    protected static final int MENU_BAR_ITEM_SHARE_CONTACT = 4;
    protected static final int MENU_BAR_ITEM_ABOUT = 5;
    protected static final int MENU_BAR_ITEM_REGISTER_PARTICIPANT = 6;
    protected static final int MENU_BAR_ITEM_GALLERY = 7;
    protected static final int MENU_BAR_ITEM_SOLUTIONS_GALLERY = 8;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        Log.d(CLASS_NAME, "Entering onPrepareOptionsMenu");
    ...
    public void setupMenuBar() {
        ...
        count++;
        if (sponsors.equals("true")) {
            MENU_BAR_TITLE_RES_ID[count] = R.string.menu_bar_partners;
            menuPosition[count] = MENU_BAR_ITEM_PARTNERS;
            count++;
        }
        if (maps.equals("true")) {
        ...
        menuListView.setPadding(16, 16, 16, 16);
        ...
        menuListView.setSelector(new ColorDrawable(getResources().getColor(R.color.theme_neutral_light_grey)));
